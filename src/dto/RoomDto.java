...
public class RoomDto {
    ...
    public RoomDto(String roomId, Integer floor, Double floorArea, String bedType, String ac, String attachedBathrooms, String catID) {
        this.roomId = roomId;
        this.floor = floor;
    ...
    public String toString() {
        return "RoomDto{" + "roomId=" + roomId + ", floor=" + floor + ", floorArea=" + floorArea + ", bedType=" + bedType + ", ac=" + ac + ", attachedBathrooms=" + attachedBathrooms + ", catID=" + catID + '}';
    }
